...
[![Stars](https://img.shields.io/github/stars/TheeTarnished/scholarytics?style=social)](https://github.com/TheeTarnished/scholarytics)
[![Version](https://img.shields.io/badge/version-4.1.0-blue)](https://github.com/TheeTarnished/scholarytics)
[![Skills](https://img.shields.io/badge/skills-15-green)](https://github.com/TheeTarnished/scholarytics/tree/main/skills)
...
|---|-------|------|:-----:|-------------|
| 1 | `scholarytics` | Orchestrator | All 6 | Main orchestrator — dispatches all sub-skills, synthesizes cross-review report |
...
| 8 | `paper-quick-scan` | Quick Assess | — | 5-minute paper snapshot · contribution type · red/green flags |
| 9 | `paper-scorecard` | Quick Assess | — | CCF 6-dim × 5-pt scorecard with confidence intervals |
| 10 | `paper-venue-match` | Quick Assess | — | Venue recommendation: CCF tier · SCI ranking · acceptance probability |
| 11 | `paper-latex-audit` | Deep Audit | — | Deep LaTeX audit: 3× compile · all warnings decoded · per-issue fix |
| 12 | `paper-citation-audit` | Deep Audit | — | Deep citation audit: semantic alignment · network analysis · missing refs |
| 13 | `paper-claim-audit` | Deep Audit | — | Deep claim audit: extract claims → locate evidence → detect false claims |
...
git clone https://github.com/TheeTarnished/scholarytics.git
...
| # | Skill | 类型 | 智能体 | 说明 |
|---|-------|------|:-----:|------|
| 1 | `scholarytics` | 主编排 | 全部6个 | 主编排器 — 调度全部子 skill，输出跨审稿综合报告 |
...
| 8 | `paper-quick-scan` | 快速评估 | — | 5分钟论文画像 · 贡献类型 · 红/绿旗标记 |
| 9 | `paper-scorecard` | 快速评估 | — | CCF 6维×5分定量评分卡 + 置信区间 |
| 10 | `paper-venue-match` | 快速评估 | — | 投稿推荐 · CCF分层匹配 · SCI期刊排名 |
| 11 | `paper-latex-audit` | 深度审计 | — | LaTeX深度审计：3次编译 · 全部warning · 逐项修复 |
| 12 | `paper-citation-audit` | 深度审计 | — | 引用深度审计：语义对齐 · 引用网络 · 遗漏关键文献 |
...
[![Star History Chart](https://api.star-history.com/svg?repos=TheeTarnished/scholarytics&type=Date)](https://star-history.com/#TheeTarnished/scholarytics&Date)
